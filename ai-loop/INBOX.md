...
**Data:** 2026-03-12
**Sessao de Teste:** Sprint 4A — Data Collector Agent POST /api/agents/data-collector
...
em contexto server-side — sem acesso a sessao. Error handler mascara erro real (nao instanceof Error).
