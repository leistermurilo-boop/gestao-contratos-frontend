      ...
      <div className="space-y-6">
        <div>
          ...
          <p className="mt-1 text-sm text-slate-500">
            Log completo de ações do sistema para conformidade LGPD.
          </p>
        </div>
        ...
        <Card className="border-slate-200">
          <CardHeader className="flex flex-row items-center gap-3 pb-3">
            ...
            <CardTitle className="text-base">Módulo de Auditoria</CardTitle>
          </CardHeader>
          <CardContent>
            <p className="text-sm text-slate-500">Conteúdo do módulo de auditoria em desenvolvimento.</p>
            <div className="mt-3">
